...
namespace Ad.Util
{
    ...
    public static class RegexHelper
    {
        ...
        /// 由非尖括号组成的字符串
        /// </summary>
        public const string reg_NotJianKuoHao_str = "^[^<>]*$";

        public static string Get_NotJianKuoHao(E_Regex_Match_Position matchPosition) { return GetRegString(reg_NotJianKuoHao_str, matchPosition); }
        ...
        public const string reg_Tel_str2 = @"^(\d{3,4}[-]?)?\d{6,8}$";
        ...
        /// 验证手机号码
        /// </summary>
        public const string reg_Mobile_str = "^[1]([3][0-9]{1}|51|52|53|54|55|56|57|58|59|81|82|83|84|85|86|88|89)[0-9]{8}$";

        public const string reg_Mobile_str2 = "^[1][358][0-9]{9}$";
        ...
        /// STMP服务器地址,包含端口号
        /// </summary>
        public const string reg_Stmp_str = @"^(smtp|SMTP).\w+[\w.]+\w:\d+$";

        /// <summary>
        /// POP3服务器地址，包括端口号
        /// </summary>
        public const string reg_Pop3_str = @"^(pop3|POP3).\w+[\w.]+\w:\d+$";
    }
}
