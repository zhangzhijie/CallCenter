...
namespace Ad.DA
{
    ...
    public abstract class OperationBase
    {
        ...
        public IList<T> Select<T>(string commandText, List<string> parameterNames, List<object> parameterValues, IDbConnection conn, IDbTransaction trans) where T: new()
        {
            var dataSet = ExecuteDataSet(GetSqlFormat(commandText), parameterNames, parameterValues, GetDataAdapter(), conn, trans);
            return ModelConvertUtility.ConvertDataTableToModelList<T>(dataSet.Tables[0]);
        }
        ...
        public virtual string GetSqlFormat(string sql)
        {
            return sql;
        }
