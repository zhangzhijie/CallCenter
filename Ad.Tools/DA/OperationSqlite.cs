...
namespace Ad.DA
{
    public class OperationSqlite : OperationBase
    {
        ...
        public static OperationSqlite Instance
        {
            get
            {
                return Ad.Util.SingletonHelper<OperationSqlite>.Instance;
            }
        }
        ...
        static OperationSqlite()
        {
            ...
            {
                //Ad.Log.LogManager.Log("OperationSqlite").Info("x64:" + path);
            ...
            //else
            //{
            //    Ad.Log.LogManager.Log("OperationSqlite").Info("x32:" + path);
            //}
