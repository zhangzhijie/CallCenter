...
namespace Ad.Model.DbModel{
 public class Y_V_ORG_MEMBER_Description {
/// <summary>
/// ID
/// </summary>
...
static Y_V_ORG_MEMBER_Description(){
...
propertyField_Dictionary.Add(DEPARTMENTNAME, "DEPARTMENTNAME");
...
fieldProperty_Dictionary.Add("DEPARTMENTNAME", DEPARTMENTNAME);
}
