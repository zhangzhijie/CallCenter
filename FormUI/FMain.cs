...
namespace FormUI
{
    public partial class FMain : Form
    {
        ...
        private void SelfContextMenuItemSelected(object sender,EventArgs e)
        {
            ...
            if (toolItem.Name == Ad.Util.Const.SelfContextMenuPrefix + (int)EnumHelper.SelfContextMenuEnum.Answer)
            {
                AnswerFunc();
            }
            else if (toolItem.Name == Ad.Util.Const.SelfContextMenuPrefix + (int)EnumHelper.SelfContextMenuEnum.Busy)
            {
                BusyFunc();
            }
        ...
        {
            FCallModule fCallModule = new FCallModule();
            fCallModule.Owner = this;
            fCallModule.ShowDialog();
        }

        public void DialForCallModule(string phone)
        {
            this.axCTISrv.cmdOffHook(AnswerHelper.CurrentChannelId);
            this.axCTISrv.cmdDial(AnswerHelper.CurrentChannelId, phone);
        }
